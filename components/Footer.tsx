    ...
    <footer className="bg-secondary border-t border-border mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-text mb-3">Quick Links</h4>
            <ul className="space-y-2">
              <li>
                <Link href="/projects" className="text-text/70 hover:text-accent transition text-sm">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-text/70 hover:text-accent transition text-sm">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-text/70 hover:text-accent transition text-sm">
                  About
                </Link>
              </li>
              <li>
                <Link href="/request" className="text-text/70 hover:text-accent transition text-sm">
                  Request Service
                </Link>
              </li>
            </ul>
